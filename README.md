...
- [`pixee-analysis`](./skills/pixee-analysis/SKILL.md) — `pixee analysis view` with `--watch`
  polling and an adjustable interval until the analysis reaches a terminal state.
